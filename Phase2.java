...
public class Phase2
{
   ...
   // Pre-built class framework for Game
   public static class CardGameFramework
   {
    ...
    public static class Hand
    {
         ...
         * if no cards, then create and return bad card
         * 
         ...
         * Returns a new bad card with errorFlag = true if k is bad
         * 
         * @return String entireHand
         */
        public Card inspectCard(int k)
        {
           if (k >= numCards)
           {
         	 ...
         	 Card badCard = new Card('S', Card.Suit.hearts);
              return badCard;
           }
           return myCards[k];
        }
